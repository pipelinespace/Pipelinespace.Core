...
{
    public class ProjectFeatureServiceEventPostRp
    {
        ...
        public ProjectFeatureServiceEventMessagePostRp Message { get; set; }
    ...
    public class ProjectFeatureServiceEventMessagePostRp
    {

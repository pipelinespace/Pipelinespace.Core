...
{
    public class ProjectGitHubHandlerService : IProjectHandlerService
    {
        ...
        public ProjectGitHubHandlerService(IOptions<FakeAccountServiceOptions> fakeAccountOptions,

...
{
    public class ProjectServiceBuildQueuedHandler : BaseHandler, IEventHandler<ProjectServiceBuildQueuedEvent>
    {
        ...
        public ProjectServiceBuildQueuedHandler(IOptions<VSTSServiceOptions> vstsOptions,
        ...
        public async Task Handle(ProjectServiceBuildQueuedEvent @event)
        {
